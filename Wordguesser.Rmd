...
join_three_df(
  join_six_df(good_bad_letters("", FALSE, words_df)
                    , good_bad_letters("a", TRUE, words_df)
                    , place_holder_letter("", 1, words_df)
                    , place_holder_letter("", 2, words_df)
                    , place_holder_letter("", 3, words_df)
                    , place_holder_letter("", 4, words_df)
                    ),
  join_six_df(place_holder_letter("", 5, words_df)
                    , out_of_pos_letter("", 1, words_df)
                    , out_of_pos_letter("", 2, words_df)
                    , out_of_pos_letter("", 3, words_df)
                    , out_of_pos_letter("", 4, words_df)
                    , out_of_pos_letter("", 5, words_df)
                    )
)

join_three_df(
                    good_bad_letters("", FALSE, words_df)
                    , good_bad_letters("a", TRUE, words_df)
                    , place_holder_letter("", 1, words_df)
)
